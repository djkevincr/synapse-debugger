...
public class SynapseDebugInterface {
    ...
    public void init(int DEBUG_PORT_LISTEN,int DEBUG_PORT_SEND)  {
       ...
       // System.out.println(SynapseDebugInterfaceConstants.LISTEN_ON_PORTS+" :"+DEBUG_PORT_LISTEN+" + "+DEBUG_PORT_SEND);
      try{
       ...
       // System.out.println(SynapseDebugInterfaceConstants.CONNECTION_CREATED);
