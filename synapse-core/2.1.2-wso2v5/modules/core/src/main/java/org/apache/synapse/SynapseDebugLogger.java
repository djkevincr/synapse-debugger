...
public class SynapseDebugLogger {
    ...
    public String getCustomLogMessage(MessageContext synCtx) {
        StringBuffer sb = new StringBuffer();
        setCustomProperties(sb, synCtx);
        return trimLeadingSeparator(sb);
    }

    public String getSimpleLogMessage(MessageContext synCtx) {
        StringBuffer sb = new StringBuffer();
    ...
    public String getHeadersLogMessage(MessageContext synCtx) {
        StringBuffer sb = new StringBuffer();
    ...
    public String getFullLogMessage(MessageContext synCtx) {
        StringBuffer sb = new StringBuffer();
    ...
    public void setCustomProperties(StringBuffer sb, MessageContext synCtx) {
