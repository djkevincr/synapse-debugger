...
public abstract class AbstractListMediator extends AbstractMediator
    ...
    private SynapseBreakPoint breakPoint=null;

    public void registerBreakPoint(SynapseBreakPoint breakPoint){this.breakPoint=breakPoint;}

    public void unregisterBreakPoint(SynapseBreakPoint breakPoint){if(this.breakPoint!=null)this.breakPoint=null;}

    public SynapseBreakPoint getRegisteredBreakPoint(){return breakPoint;}
